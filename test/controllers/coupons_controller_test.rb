...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { code: @coupon.code, discount: @coupon.discount, one_use: @coupon.one_use, type: @coupon.type } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { code: @coupon.code, discount: @coupon.discount, one_use: @coupon.one_use, type: @coupon.type } }
